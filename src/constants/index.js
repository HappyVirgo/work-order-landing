...
//Job Titles WO
export const RECEIVE_JOB_TITLES_WO_NOTES_DATA = 'RECEIVE_JOB_TITLES_WO_NOTES_DATA';

//Job Titles WO
export const RECEIVE_SERVICE_PROVIDERS_WO_NOTES_DATA = 'RECEIVE_SERVICE_PROVIDERS_WO_NOTES_DATA';

//Cancel Work Order
export const CANCEL_WORK_ORDER = 'CANCEL_WORK_ORDER'

// SP Reassign Work Order
export const RECEIVE_SERVICE_PROVIDERS_REASSIGN_DATA = 'RECEIVE_SERVICE_PROVIDERS_REASSIGN_DATA'

// Reassign Work Order
export const REASSIGN_WORK_ORDER_DATA = 'REASSIGN_WORK_ORDER_DATA'

// User Permissions
export const RECEIVE_USER_PERMISIONS_DATA = 'RECEIVE_USER_PERMISIONS_DATA'
