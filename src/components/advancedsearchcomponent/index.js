...
const advancedSearchFields = ["Search Within Results", "Service Provider" ,"Asset Type", "Problem Type", "Trade Type", "Category Type"]
    ...
    return (
        <div className={`search-form ${searchBox?'rounded':''}`}>
            ...
            <FormControl className={classes.search}>           
                <TextField 
                    placeholder={`${searchByState===1?"":"Search by"} ${advancedSearchFields[searchByState-1]}...`}
